-- 🗑️ TRIGGERS D'INVALIDATION INTELLIGENTE DU CACHE
-- Date: 2025-01-28
...
-- 12. Log de création (optionnel - table migration_log n'existe pas forcément)
-- INSERT INTO public.migration_log (migration_name, applied_at, description) 
-- VALUES (
--   'create_cache_invalidation_triggers',
--   NOW(),
--   'Triggers d''invalidation intelligente du cache avec priorité critique'
