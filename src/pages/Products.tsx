    ...
    <DashboardLayout>
      <div className="space-y-3 sm:space-y-4 lg:space-y-6 w-full">
        ...
        <div className="relative overflow-hidden w-full">
          ...
          <div className="relative p-3 sm:p-4 lg:p-6 xl:p-8 bg-gradient-to-br from-background via-background to-muted/20 rounded-2xl sm:rounded-3xl border border-border/50 shadow-lg w-full">
            <ProductsHeader
        ...
        <div className="relative w-full">
          {selectedStoreId ? (
            <div className="bg-gradient-to-br from-background via-background to-muted/10 rounded-xl sm:rounded-2xl border border-border/50 shadow-lg p-3 sm:p-4 lg:p-6 w-full">
              <ProductList
                products={products}
                isLoading={isLoading}
            ...
            <div className="bg-gradient-to-br from-background via-background to-muted/20 rounded-xl sm:rounded-2xl border border-border/50 shadow-lg p-3 sm:p-4 lg:p-6 xl:p-8 w-full">
              <NoStoreSelected />
            </div>
          )}
        </div>
