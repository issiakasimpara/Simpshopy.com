        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-6 xl:space-x-10">
              ...
              <Link to="/features" className="text-blue-600 font-medium text-sm xl:text-lg">Fonctionnalités</Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Découvrez toutes les fonctionnalités qui font de SimpShopy la plateforme e-commerce 
              la plus complète pour les entrepreneurs ambitieux.
            </p>
