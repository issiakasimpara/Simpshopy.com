...
import { Plus, Trash2, Image, Shield, Trophy } from 'lucide-react';
...
const SportsEditor = ({ block, onUpdate }: SportsEditorProps) => {
  const [localCategories, setLocalCategories] = useState(block.content.categories || []);

  const addCategory = () => {
    const newCategory = {
      name: 'Nouvelle Catégorie Sport',
      description: 'Description de la catégorie sportive',
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <Input
          ...
          placeholder="Performance et qualité"
        />
      </div>

      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <Label>Catégories sportives</Label>
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <Input
                  ...
                  placeholder="Nom de la catégorie sportive"
                />
                <Button
                  size="sm"
                  variant="ghost"
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Description de la catégorie sportive"
                    rows={2}
                  />
                </div>
                <div>
