...
/**
 * 🧹 Script de Nettoyage Simple des Console.log
 * Remplace automatiquement les console.log par logger approprié
 */
  ...
  const patterns = [
    // console.log simple
    {
      ...
      replacement: (match, args) => {
        replacements++;
        return `logger.debug(${args}, undefined, '${sourceName}');`;
      }
    },
    // console.error
    {
      ...
      replacement: (match, args) => {
        replacements++;
        return `logger.error(${args}, undefined, '${sourceName}');`;
      }
    },
    // console.warn
    {
      ...
      replacement: (match, args) => {
        replacements++;
        return `logger.warn(${args}, undefined, '${sourceName}');`;
      }
    },
    // console.info
    {
      ...
      replacement: (match, args) => {
        replacements++;
        return `logger.info(${args}, undefined, '${sourceName}');`;
      }
    }
  ];
 ...
 */
function main() {
  console.log('🧹 Démarrage du nettoyage simple des console.log...');
