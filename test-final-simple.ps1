...
Write-Host "Test final ZeptoMail avec les vrais templates" -ForegroundColor Cyan
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="status">
                ...
                <p style="margin: 10px 0 0 0; color: #166534;">Votre commande a ete recue et est en cours de traitement</p>
            </div>
            ...
            <h3 style="color: #374151;">Resume de votre commande</h3>
            ...
            <div class="info-box">
                ...
                <p style="margin: 5px 0; color: #92400e;"><strong>Statut :</strong> En preparation</p>
                <p style="margin: 5px 0; color: #92400e;"><strong>Delai estime :</strong> 3-5 jours ouvrables</p>
                <p style="margin: 5px 0; color: #92400e;"><strong>Methode de paiement :</strong> Moneroo</p>
            </div>
            ...
            <div class="help-section">
                ...
                <p style="margin: 5px 0; color: #6b7280;">Si vous avez des questions concernant votre commande, n'hesitez pas a nous contacter :</p>
                <p style="margin: 5px 0; color: #6b7280;"><strong>Email :</strong> contact@simpshopy.com</p>
                <p style="margin: 5px 0; color: #6b7280;"><strong>Numero de commande :</strong> #CMD-20250128-123456</p>
            </div>
        </div>
...
Write-Host "L'email envoye utilise EXACTEMENT le meme template que celui affiche dans la previsualisation!" -ForegroundColor Cyan
Write-Host "Verifiez sirikisuv@gmail.com pour voir le resultat final!" -ForegroundColor Yellow
Write-Host "CONFIRMATION: Les templates affiches correspondent bien a ceux utilises dans le systeme!" -ForegroundColor Green
